...
if __name__ == "__main__":
	...
	model = vgg16()
	model.load_weights('/local/akonwar/trained_weights/mobilenet_sgd_valid_40k_51-100.h5')
	...
	plt.legend(['train', 'validation'], loc='upper left')  
	#plt.show()
	plt.savefig('/udd/akonwar/code/deep-learning-for-visual-servoing/visualization_mobilenet_sgd_valid_40k_51-75.png')


	model.save_weights('/local/akonwar/trained_weights/mobilenet_sgd_valid_40k_51-75.h5')
