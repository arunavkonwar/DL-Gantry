...
def InceptionV1(include_top=True,
    ...
    model1 = Model(inputs=inputs, output=[trans_fc,rot_fc])
...
if __name__ == "__main__":
	...
	y_filename ='/udd/akonwar/code/deep-learning-for-visual-servoing/data/data_high_precision_500.txt'
	...
	h5f = h5py.File('/local/akonwar/image_data/6dof_high-precision_500.h5','r')
	...
	plt.savefig('googlenet_single-output_imagenet_iter-150-6dof_high-precision_500.png')


	model.save_weights('/local/akonwar/trained_weights/googlenet_single-output_imagenet_iter-150-6dof_high-precision_500.h5')       
