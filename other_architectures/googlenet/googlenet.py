...
if __name__ == "__main__":
	...
	y_filename ='/udd/akonwar/code/deep-learning-for-visual-servoing/data/data_high_precision_5k.txt'
	...
	h5f = h5py.File('/local/akonwar/image_data/6dof_high-precision_5k.h5','r')
	...
	plt.savefig('googlenet_single-output_imagenet_iter-150-6dof_high-precision_5k.png')


	model.save_weights('/local/akonwar/trained_weights/googlenet_single-output_imagenet_iter-150-6dof_high-precision_5k.h5')       
