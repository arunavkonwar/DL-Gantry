def vgg16():
	...
	resnet = keras.applications.vgg16.VGG16(include_top=False, weights='imagenet', input_tensor=None, input_shape=(224,224,3), classes=1000)
...
if __name__ == "__main__":
	...
	plt.legend(['train', 'validation'], loc='upper left')  
	#plt.show()
	plt.savefig('visualization_vgg16_90percent_1-300_adam_00001.png')


	model.save_weights('/local/akonwar/trained_weights/trained_model_vgg16_90percent_1-300_adam_00001.h5')
