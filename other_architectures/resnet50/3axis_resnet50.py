...
if __name__ == "__main__":
	...
	plt.legend(['train', 'validation'], loc='upper left')  
	#plt.show()
	plt.savefig('visualization_resnet50_90percent_1-100_eminus5_3axis_by255.png')


	model.save_weights('/local/akonwar/trained_weights/trained_model_resnet50_90percent_1-100_eminus5_3axis_by255.h5')
