...
if __name__ == "__main__":
	...
	model = vgg16()
	model.load_weights('/local/akonwar/trained_weights/trained_model_sgd_valid_40k_1-60_36-45.h5')
	...
	plt.legend(['train', 'validation'], loc='upper left')  
	#plt.show()
	plt.savefig('visualization_sgd_valid_40k_1-60_46-65.png')


	model.save_weights('/local/akonwar/trained_weights/trained_model_sgd_valid_40k_1-60_46-65.h5')
